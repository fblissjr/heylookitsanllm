...
Usage:
    uv run apps/optloop-lib/scripts/bench_vlm.py
    uv run apps/optloop-lib/scripts/bench_vlm.py --model-path <path>
    uv run apps/optloop-lib/scripts/bench_vlm.py --reset-baseline
    uv run apps/optloop-lib/scripts/bench_vlm.py --text-only
    uv run apps/optloop-lib/scripts/bench_vlm.py --vision-only
"""
...
def bench_vision_prompt(
    ...
    with wired_limit(model, [mx.default_stream(mx.default_device())]):
        ...
        # Force GPU synchronization on the logprobs computation
