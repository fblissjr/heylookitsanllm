...
| `E2E_PORT`            | `1264`                               | server port for the spawned instance -- deliberately NOT 1263, the daily server's port (the harness spawns its OWN server and must never collide with it) |
