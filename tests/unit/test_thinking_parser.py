...
Tests both the non-streaming parse_thinking_content function and
the StreamingThinkingParser class.
"""
import pytest
from heylook_llm.thinking_parser import parse_thinking_content, StreamingThinkingParser
