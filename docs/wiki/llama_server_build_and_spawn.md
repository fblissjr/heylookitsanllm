...
- **Log Management**: Subprocess stdout/stderr behavior is controlled by `observability_level`:
  - `observability_level == "off"` (default): Output redirects to `subprocess.DEVNULL`.
