...
| [**Providers & Generation**](./providers_architecture.md) | Multi-Engine Providers | Unified provider abstraction (`BaseProvider`), `GenerationChunk` contract, MLXProvider (`mlx-lm` vs `mlx-vlm`), reasoning parsers, and FIFO generation gate. |
