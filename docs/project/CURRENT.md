...
its closed sections are in the local, unversioned `internal/archive/todo_closed_2026-09-25.md`), and what each release
...
- v2.0.128: MLX image sources refuse local file paths (data URLs and http(s)
  links only); v2.0.129: `uv.lock` upgraded (starlette 1.7, huggingface-hub
