...
| MLX greedy chain probe (`internal/claude/w10/chain_probe.py`) | gemma-4-26B-A4B: every extend and edit hop reuses and matches fresh output at temperature 0 | v2.0.84 |
